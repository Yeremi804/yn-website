    ...
    return (
        <Box className="py-12">
           <header className="mb-12">
             <h1 className="text-4xl font-bold text-brand-text mb-4">Featured Projects</h1>
             <p className="text-lg text-gray-600">A selection of my recent work showcasing various skills and technologies.</p>
           </header>

           <Container cols="grid-cols-1 md:grid-cols-2 lg:grid-cols-3" className="gap-8">
